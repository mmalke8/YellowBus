  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      <ul class="nav navbar-nav">
        <li><a href="parents.jsp">Home</a></li>
        </ul>
...
<div class="container-fluid text-center">    
  <div class="row content">
    ...
    <div class="col-sm-8 text-left"> 
      <h2>Track your child's Bus</h2>
      <div class="col-sm-12 text-center">
      <button class="btn btn-success" onclick="myMap()">Begin Tracking</button>
      </div>
      
      <div class="col sm-8 text-center" id="map" style="width:100%;height:300px">
...
<%
	...
	Location location = parent.getStudent().getLocation();
